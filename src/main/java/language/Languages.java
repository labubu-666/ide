...
public final class Languages {
    ...
    private static final String DEFAULT_ICON = "editor/icons/document.png";

    public static final Language UNKNOWN = new Language(
        "unknown", List.of(), DEFAULT_ICON, "plaintext",
        null, null, "/editor/keywords/java.css"
    );
    ...
    private static final List<Language> ALL = List.of(
        ...
        new Language(
            ...
            "/editor/keywords/typescript.css"
        ),
        new Language(
